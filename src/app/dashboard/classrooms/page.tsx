    ...
    <div className="space-y-6">
      ...
      <Card className="border shadow-sm">
        <CardContent className="flex flex-col items-center justify-center py-16">
          <div className="rounded-2xl bg-gradient-to-br from-teal-50 to-emerald-50 p-6 mb-6">
            <School className="h-12 w-12 text-teal-500" />
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-lg mb-8">
            <div className="flex flex-col items-center text-center p-3">
              <Video className="h-5 w-5 text-teal-500 mb-2" />
            ...
            <div className="flex flex-col items-center text-center p-3">
              <ClipboardList className="h-5 w-5 text-emerald-500 mb-2" />
