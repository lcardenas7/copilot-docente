    ...
    <div className="flex min-h-screen flex-col">
      ...
      <header className="sticky top-0 z-50 w-full border-b border-white/10 bg-white/80 backdrop-blur-xl">
        <div className="container mx-auto flex h-16 items-center justify-between px-4 sm:px-6">
          ...
          <nav className="flex items-center space-x-3">
            ...
            <Link href="/login">
              <Button className="bg-gradient-to-r from-indigo-600 to-violet-600 hover:from-indigo-700 hover:to-violet-700 text-white shadow-lg shadow-indigo-500/25 text-sm">
                Comenzar gratis
              </Button>
            </Link>
          </nav>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 -z-10">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[600px] bg-gradient-to-br from-indigo-100 via-violet-50 to-pink-50 rounded-full blur-3xl opacity-60" />
          ...
          <div className="absolute top-60 left-0 w-[300px] h-[300px] bg-gradient-to-br from-violet-100 to-transparent rounded-full blur-3xl opacity-40" />
        </div>
        ...
        <div className="container mx-auto flex flex-col items-center justify-center px-4 sm:px-6 py-20 sm:py-28 lg:py-36 text-center">
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-4">
            <Link href="/login">
              <Button size="lg" className="text-base px-8 h-12 bg-gradient-to-r from-indigo-600 to-violet-600 hover:from-indigo-700 hover:to-violet-700 text-white shadow-xl shadow-indigo-500/30 rounded-xl">
                Comenzar gratis
      ...
      <section id="features" className="relative py-24 sm:py-32">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-16">
            <div className="inline-flex items-center rounded-full border border-indigo-200 bg-indigo-50 px-3 py-1 text-xs font-semibold text-indigo-700 mb-4 uppercase tracking-wider">
              Herramientas
            </div>
      ...
      <section className="relative py-24 sm:py-32 overflow-hidden">
        <div className="absolute inset-0 -z-10 bg-gradient-to-b from-indigo-50/50 via-violet-50/30 to-transparent" />
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-16">
            <div className="inline-flex items-center rounded-full border border-violet-200 bg-violet-50 px-3 py-1 text-xs font-semibold text-violet-700 mb-4 uppercase tracking-wider">
              Cómo funciona
            </div>
            <h2 className="text-3xl font-extrabold tracking-tight sm:text-4xl lg:text-5xl">
              Tres pasos y listo
      ...
      <section className="py-24 sm:py-32">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-16">
            <div className="inline-flex items-center rounded-full border border-emerald-200 bg-emerald-50 px-3 py-1 text-xs font-semibold text-emerald-700 mb-4 uppercase tracking-wider">
              Planes
            </div>
            <h2 className="text-3xl font-extrabold tracking-tight sm:text-4xl lg:text-5xl">
      ...
      <section className="relative py-24 sm:py-32 overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 text-center relative">
          ...
          <Link href="/login">
            <Button size="lg" className="mt-10 text-base px-8 h-12 bg-white text-indigo-700 hover:bg-indigo-50 shadow-xl rounded-xl font-semibold">
...
function StepCard({
  ...
  return (
    <div className="text-center">
      <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-indigo-600 to-violet-600 text-white text-2xl font-bold shadow-lg shadow-indigo-500/30">
        {number}
      </div>
      <h3 className="mt-5 text-lg font-bold">{title}</h3>
      <p className="mt-2 text-muted-foreground leading-relaxed">{description}</p>
  ...
  return (
    <div
      className={`relative rounded-2xl border p-8 transition-all duration-300 ${
        highlighted
          ? "border-indigo-300 bg-gradient-to-b from-indigo-50 to-white shadow-xl shadow-indigo-500/10 scale-105 ring-1 ring-indigo-200"
          : "bg-card hover:shadow-lg hover:-translate-y-1"
      }`}
    >
      {highlighted && (
        <div className="absolute -top-3 left-1/2 -translate-x-1/2 inline-flex items-center rounded-full bg-gradient-to-r from-indigo-600 to-violet-600 px-4 py-1 text-xs font-semibold text-white shadow-lg">
          Popular
        </div>
      )}
      ...
      <ul className="mt-8 space-y-3">
        {features.map((feature) => (
          <li key={feature} className="flex items-center text-sm">
            <CheckCircle className="mr-3 h-4 w-4 text-indigo-500 shrink-0" />
            {feature}
          </li>
        ))}
      </ul>
